...
namespace SampleApplication.Repo
{
    public class EfRepository<T> : IRepository<T>
         where T : class
    {
        protected SampleApplicationEntities Context;
        ...
        public EfRepository()
        {
            Context = new SampleApplicationEntities();
        }
        ...
        public SampleApplicationEntities GetContext()
        {
            return new SampleApplicationEntities();
        }
